...
import com.venus.modules.gen.entity.ColumnEntity;
import com.venus.modules.gen.entity.TableEntity;
...
public class GenUtils {
     ...
     * 生成代码
     */
    public static void genCode(TableDTO table, List<TableDTO> columns, ZipOutputStream zip) {
        //配置信息
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new VenusException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new VenusException("获取配置文件失败，", e);
        }
    }
